<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*, com.notice.model.vo.*,java.util.*, com.common.Search"%>    
<% 
...
<div><%@ include file="../common/header.jsp" %> </div>
	...
	<div class="row">
        ...
        <table align="center" style="border: 1px dotted white;
    		    border-bottom: 1px solid gray;" id="listArea">
...
<% String pageURL =   request.getContextPath() + "/searchNotice.no?con=" + s.getCondition() + "&keyword=" + s.getKeyword() + "&currentPage="; %>
